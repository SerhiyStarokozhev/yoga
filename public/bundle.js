...
function calc() {
  ...
  restDays.addEventListener('keydown', function (event) {
    numbers(event);
  });
  ...
  function numbers(event) {
    ...
    if (num == 46 || num == 8 || num == 9 || num == 27 || num == 65 && event.ctrlKey === true || num >= 35 && num <= 39) {
      return;
    } else {
...
function timer() {
  ...
  function setClock(id, endtime) {
    ...
    function updateClock() {
      var t = getTimeReamining(endtime);
